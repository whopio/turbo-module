...
;// CONCATENATED MODULE: ./dist/release-pull/shared.js
var fullReleaseTitle = "(turbo-module): release next version";
var canaryReleaseTitle = "(turbo-module): release next canary version";

// EXTERNAL MODULE: ../../node_modules/.pnpm/semver@7.3.8/node_modules/semver/functions/inc.js
var inc = __webpack_require__(7451);
var inc_default = /*#__PURE__*/__webpack_require__.n(inc);
;// CONCATENATED MODULE: ./dist/release-pull/create.js
        ...
        return __generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    _iterator = _asyncIterator(context/* octo.paginate.iterator */.NR.paginate.iterator(context/* octo.rest.pulls.list */.NR.rest.pulls.list, {
                ...
                case 3:
                    ...
                    try {
                        for(_iterator1 = pulls[Symbol.iterator](); !(_iteratorNormalCompletion = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion = true){
                            pull = _step1.value;
                            if ((0,is_action_user/* default */.Z)(pull.user)) {
                                ...
                                return __generator(this, function(_state) {
                                    switch(_state.label){
                                        case 0:
                                            return [
                                                4,
                                                context/* octo.rest.pulls.update */.NR.rest.pulls.update({
                                                    repo: context/* repo */.O9,
                                                    owner: context/* owner */.cR,
                                        ...
                                        case 1:
                                            ...
                                            return [
                                                4,
                                                context/* octo.rest.git.deleteRef */.NR.rest.git.deleteRef({
                                                    repo: context/* repo */.O9,
                                                    owner: context/* owner */.cR,
        ...
        return __generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        context/* octo.rest.issues.createComment */.NR.rest.issues.createComment({
                            repo: context/* repo */.O9,
                            owner: context/* owner */.cR,
                            issue_number: number,
...
var createPull = function() {
    var _ref = _asyncToGenerator(function(prerelease) {
        ...
        return __generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    title = prerelease ? canaryReleaseTitle : fullReleaseTitle;
                ...
                case 1:
                    ...
                    if (!packageJson.version || packageJson.version.startsWith("0.0.0")) {
                        ...
                        newVersion = prerelease ? inc_default()(packageJson.version, "prerelease", "canary") : inc_default()(packageJson.version, "patch");
                    }
                    if (!newVersion) throw new Error("Could not increase version");
                    packageJson.version = newVersion;
                    return [
                        4,
                        context/* octo.rest.git.getRef */.NR.rest.git.getRef({
                            owner: context/* owner */.cR,
                            repo: context/* repo */.O9,
                            ref: "heads/main"
                        })
                ...
                case 2:
                    ...
                    return [
                        4,
                        context/* octo.rest.git.createRef */.NR.rest.git.createRef({
                            owner: context/* owner */.cR,
                            repo: context/* repo */.O9,
                            sha: sha,
                ...
                case 5:
                    ...
                    return [
                        4,
                        context/* octo.rest.pulls.create */.NR.rest.pulls.create({
                            repo: context/* repo */.O9,
                            owner: context/* owner */.cR,
                            title: title,
                            body: message,
...
/* harmony default export */ const create = ((/* unused pure expression or super */ null && (runAction)));

;// CONCATENATED MODULE: ./dist/release-pull/sync.js
function sync_asyncIterator(iterable) {
    var method, async, sync, retry = 2;
    for("undefined" != typeof Symbol && (async = Symbol.asyncIterator, sync = Symbol.iterator); retry--;){
        if (async && null != (method = iterable[async])) return method.call(iterable);
        if (sync && null != (method = iterable[sync])) return new sync_AsyncFromSyncIterator(method.call(iterable));
        async = "@@asyncIterator", sync = "@@iterator";
    }
    throw new TypeError("Object is not async iterable");
}
function sync_AsyncFromSyncIterator(s) {
    function AsyncFromSyncIteratorContinuation(r) {
        if (Object(r) !== r) return Promise.reject(new TypeError(r + " is not an object."));
        var done = r.done;
        return Promise.resolve(r.value).then(function(value) {
    ...
    return(sync_AsyncFromSyncIterator = function(s) {
        this.s = s, this.n = s.next;
    }, sync_AsyncFromSyncIterator.prototype = {
        s: null,
        n: null,
        next: function() {
            return AsyncFromSyncIteratorContinuation(this.n.apply(this.s, arguments));
    ...
    }, new sync_AsyncFromSyncIterator(s));
}
function sync_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
    try {
        var info = gen[key](arg);
        var value = info.value;
    } catch (error) {
...
function sync_asyncToGenerator(fn) {
    return function() {
        var self = this, args = arguments;
        return new Promise(function(resolve, reject) {
            var gen = fn.apply(self, args);
            function _next(value) {
                sync_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);
            }
            function _throw(err) {
                sync_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);
            }
            _next(undefined);
        });
    };
}
var sync_generator = undefined && undefined.__generator || function(thisArg, body) {
    var f, y, t, g, _ = {
        label: 0,
        sent: function() {
            if (t[0] & 1) throw t[1];
...
var syncPull = function() {
    var _ref = sync_asyncToGenerator(function(pull, prerelease) {
        var message;
        return sync_generator(this, function(_state) {
            switch(_state.label){
                case 0:
...
var sync_runAction = function() {
    var _ref = sync_asyncToGenerator(function() {
        ...
        return sync_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    _iterator = sync_asyncIterator(context/* octo.paginate.iterator */.NR.paginate.iterator(context/* octo.rest.pulls.list */.NR.rest.pulls.list, {
                        repo: context/* repo */.O9,
                        owner: context/* owner */.cR,
                        state: "open",
                        sort: "created",
...
/* harmony default export */ const sync = (sync_runAction);
